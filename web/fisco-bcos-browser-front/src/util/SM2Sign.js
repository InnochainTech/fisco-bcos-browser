...
/*let hashData = sm3Digest("trans()");
console.log("hashData:",hashData);

let pri = "c9a497f262b30acc933891257c5652f04d2de8b01bd0fbf939e497f215f5394f";
let pub = "04756185a0cd1a3b240bd8fd400b0f34083f557cb3a2a80f0cfb8f9f093f21ed8e349908e3d641db6fe43b152d1cb2180834a398d5e3314403d01178339b6447af";
let msg = "123456";
let signData = signRS(pri,msg);
let verifyRS = verifyRS(pub,msg,signData);
console.log("verifyRSResult:",verifyRS);*/

/*let genKey = sm2GenKey("sm2");
let pri = genKey.ecprvhex;
let pub = genKey.ecpubhex;
...
let _sign = sm2Sign(pri,msg);
let lresult = verify(pub,msg,_sign);
console.log("verifyResult:" + lresult);

let hashData = sm3Digest(msg);
